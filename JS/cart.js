...
function totalPrinter() {
  ...
  dollar.innerText = `$${totalInDollar.toFixed(2)}`;
  let totalInRupees = 81.95 * totalInDollar;
  inr.innerText = `₹${totalInRupees.toFixed(2)}`;
...
function summaryListDiv(prod, qty) {
  ...
  div13.className = "itemRate";
  div13.innerText = `Price: $${prod.price}`;
  div11.appendChild(div13);

  let div14 = document.createElement("div");
  div14.className = "itemQuant";
  let div15 = document.createElement("div");
  div15.className = "name";
  div15.innerText = "Qty";
  div14.appendChild(div15);
  let div16 = document.createElement("div");
  div16.className = "number";
  div16.innerText = `${qty}`;
